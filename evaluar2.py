...
# === 2. CARGAR EL MODELO ENTRENADO (¡AQUÍ ESTÁ EL CAMBIO!) ===
# Cambiamos el nombre del archivo para cargar el nuevo modelo avanzado.
try:
    modelo_cargado = tf.keras.models.load_model('modelo_fisuras_avanzado.keras')
    print("✅ Modelo 'modelo_fisuras_avanzado.keras' cargado exitosamente.")
except Exception as e:
    print(f"❌ Error al cargar el modelo: {e}")
    print("Asegúrate de haber ejecutado 'entrenamiento2.py' para guardar el modelo primero.")
    exit()
...
# === 5. CONTEO MANUAL DE PREDICCIONES ===
# Esta parte no cambia.
